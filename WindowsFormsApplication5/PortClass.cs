...
class PortClass
{
    ...
    */
    public PortClass(string myIpAddress, int myPort, string cloudIpAddress, int cloudPort)
    {
    ...
    */
    private void InitializeData(string myIpAddress, int myPort, string cloudIpAddress, int cloudPort)
    {
